...
*   
*   5.19 Expanded: Modify undecl so that it does not add redundant parenthesis to declarations. Include functionality with modifers.
*   
*   Notes: This is 5.19_inverse_5.20_modifiers which takes the full output of 5.20_modifiers and returns the symbolic declaration. This 
*   has the same limitations as 5.19_inverse_5.20 for everything else.
*********************************************************************************************************************************************/
#include <stdio.h>
#include <string.h>
#include <ctype.h>
...
/* Fun examples 
    x: function passing nothing returning pointer to array[] of pointer to function passing nothing returning char stored as static.
        -> static char (*(*x())[])()
