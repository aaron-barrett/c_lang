...
/* Fun examples 
    ...
    x: function passing nothing returning pointer to array[] of pointer to function passing struct sqr returning pointer to struct str.
        -> struct str *(*(*x())[])(struct sqr)
