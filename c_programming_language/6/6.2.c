...
*   
*   6.2: Write a program that reads a C program and prints in alphabetical order each group of variable names that are identical in the first 
*   6 characters, but different somewhere hereafter. Make 6 a parameter that can be set from the command line.
*   
*   Notes: The wording above needs a little clarification: "but different hereafter" simply means "match first 6 letters".
*********************************************************************************************************************************************/
#include <stdio.h>
#include <ctype.h>
#include <string.h>
